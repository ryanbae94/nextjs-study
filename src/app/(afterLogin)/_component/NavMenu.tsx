          ...
          <div className={styles.navPill}>
            {segment === 'home' ? (
              ...
              <>
                ...
                <div className={styles.navPillDiv}>홈</div>
              </>
            )}
          </div>
        </Link>
          ...
          <div className={styles.navPill}>
            {segment && ['search', 'explore'].includes(segment) ? (
              ...
              <>
                ...
                <div className={styles.navPillDiv}>탐색하기</div>
              </>
            )}
          </div>
        </Link>
          ...
          <div className={styles.navPill}>
            {segment === 'messages' ? (
              ...
              <>
                ...
                <div className={styles.navPillDiv}>쪽지</div>
              </>
            )}
          </div>
        </Link>
            ...
            <div className={styles.navPill}>
              {segment === me.id ? (
                ...
                <>
                  ...
                  <div className={styles.navPillDiv}>프로필</div>
                </>
              )}
            </div>
          </Link>
